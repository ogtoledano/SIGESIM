...
import infoartex.artex.bundles.ConfirmDialog.Factory;
...
public class DefaultConfirmDialogFactory implements Factory {
    ...
    public ConfirmDialog create(final String caption, final String message,
        ...
        final NativeButton cancel = new NativeButton(cancelCaption != null ? cancelCaption
        ...
        NativeButton notOk = null;
        if (threeWay) {
            notOk = new NativeButton(notOkCaption);
            notOk.setData(false);
        ...
        final NativeButton ok = new NativeButton(okCaption != null ? okCaption
                : DEFAULT_OK_CAPTION);
        ok.setData(true);
        ...
        NativeButton.ClickListener cb = new NativeButton.ClickListener() {
