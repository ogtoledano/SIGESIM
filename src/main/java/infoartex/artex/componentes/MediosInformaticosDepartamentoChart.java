...
public class MediosInformaticosDepartamentoChart extends ComponenteGenerico {
	private VerticalLayout main;

	public MediosInformaticosDepartamentoChart(final Administrar view) {
		super(view);
	...
	public void cargarSeries(ChartConfiguration area) {
		...
		for (Departamento dep : despartamentos) {
			series.addData(new PieChartData(dep.getNombre(), dep.getMedio().size()));
		}
